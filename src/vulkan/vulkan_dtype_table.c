...
static int check_native(ace_dtype_t dtype) {
    switch (dtype) {
        ...
        case ACE_DTYPE_FLOAT64: return g_device_features.has_float64 && g_device_features.has_64bit_storage;
        case ACE_DTYPE_INT64: return g_device_features.has_int64 && g_device_features.has_64bit_storage;
        case ACE_DTYPE_FLOAT16: return g_device_features.has_float16 && g_device_features.has_16bit_storage;
        case ACE_DTYPE_BFLOAT16: return 0;
        case ACE_DTYPE_INT8: case ACE_DTYPE_UINT8: return g_device_features.has_int8 && g_device_features.has_8bit_storage;
        case ACE_DTYPE_INT16: return g_device_features.has_int16 && g_device_features.has_16bit_storage;
        default: return 1;
    }
}

const dtype_info_t* get_dtype_table(void) {
    if (g_init) return g_table;

    int native_fp64 = check_native(ACE_DTYPE_FLOAT64);
    int native_int64 = check_native(ACE_DTYPE_INT64);
